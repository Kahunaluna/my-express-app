...
router.post("/api/games", isAuthenticated, async (req, res) => {
  try {
...
router.put("/api/games/:id", isAuthenticated, async (req, res) => {
  try {
    const { gameName, ranking } = req.body;
...
router.delete("/api/games/:id", isAuthenticated, async (req, res) => {
  try {
